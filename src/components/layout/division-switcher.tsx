...
export function DivisionSwitcher() {
  ...
  if (isLoading) {
    return (
      <div className="hidden items-center gap-2 px-2 text-xs text-[#66778f] lg:flex">
  ...
  return (
    <label className="hidden min-w-0 items-center gap-1.5 rounded-sm border border-[#c8d2df] bg-white px-2 py-1 text-xs text-[#4e5c6e] lg:flex">
      ...
      <select
        ...
        className="max-w-52 min-w-28 cursor-pointer bg-transparent font-medium text-[#111319] outline-none disabled:cursor-wait"
      >
